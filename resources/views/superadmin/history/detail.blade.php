...
@section('content')
    <div class="card card-outline card-primary">
        <div class="card-body">
            <h4 class="text-center">Detail Perhitungan Hasil Rekomendasi - {{ $historyItem['lokasi_iup'] }}</h4>
    ...
    <!-- Include the rest of the tables from detailrekomendasi/index.blade.php -->
    <!-- Tahap Normalisasi -->
    ...
    <!-- Tahap Perhitungan Nilai Prefrensi -->
    <div class="card card-outline card-primary mt-4">
        <div class="card-body">
    ...
    <!-- Tahap Perangkingan dan Kesimpulan -->
    <div class="card card-outline card-primary mt-4">
        <div class="card-body">
...
@push('js')
    <script>
        document.getElementById("btn_kembali").addEventListener("click", function() {
            window.location.href = "{{ route('superadmin.history.index') }}";
        });
    </script>
@endpush