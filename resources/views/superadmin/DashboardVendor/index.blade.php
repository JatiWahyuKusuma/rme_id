          ...
          <div class="row">
            <div class="col-lg-4 col-6">
                <div class="small-box bg-success text-center">
                    ...
                    <p style="font-size: 20px; margin-top: -10px; margin-bottom: 10px;">Total Kap(ton/thn)</p> <!-- Increased font size for label -->
                    <div class="icon">
            ...
            <div class="col-lg-4 col-6">
                <div class="small-box bg-warning text-center">
                    ...
                    <p style="font-size: 20px; margin-top: -10px; margin-bottom: 10px;">Unit Produksi BB</p> <!-- Increased font size for label -->
                    <div class="icon">
            ...
            <div class="col-lg-4 col-6">
                <div class="small-box bg-info text-center">
                    ...
                    <p style="font-size: 20px; margin-top: -10px; margin-bottom: 10px;">Total Vendor BB</p> <!-- Increased font size for label -->
                    <div class="icon">
