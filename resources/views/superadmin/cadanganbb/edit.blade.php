    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            @empty($cadanganbb)
                ...
                <a href="{{ url('cadanganbb') }}" class="btn btn-sm btn-default mt 2">Kembali</a>
            @else
                <form method="POST" action="{{ url('/cadanganbb/' . $cadanganbb->cadanganbb_id) }}" class="form-horizontal">
                    @csrf
                    {!! method_field('PUT') !!}
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="opco_id" name="opco_id"
                                value="{{ old('opco_id', $cadanganbb->opco_id) }}" readonly>
                            @error('opco_id')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="latitude" name="latitude"
                                value="{{ old('latitude', $cadanganbb->latitude) }}">
                            @error('latitude')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="longitude" name="longitude"
                                value="{{ old('longitude', $cadanganbb->longitude) }}">
                            @error('longitude')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="jarak" name="jarak"
                                value="{{ old('jarak', $cadanganbb->jarak) }}">
                            @error('jarak')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="luas_ha" name="luas_ha"
                                value="{{ old('luas_ha', $cadanganbb->luas_ha) }}">
                            @error('luas_ha')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="kebutuhan_pertahun_ton" name="kebutuhan_pertahun_ton"
                                value="{{ old('kebutuhan_pertahun_ton', $cadanganbb->kebutuhan_pertahun_ton) }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="komoditi" name="komoditi"
                                value="{{ old('komoditi', $cadanganbb->komoditi) }}" required>
                            @error('komoditi')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="lokasi_iup" name="lokasi_iup"
                                value="{{ old('lokasi_iup', $cadanganbb->lokasi_iup) }}" required>
                            @error('lokasi_iup')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="sd_cadangan_ton" name="sd_cadangan_ton"
                                value="{{ old('sd_cadangan_ton', $cadanganbb->sd_cadangan_ton) }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="status_penyelidikan" name="status_penyelidikan"
                                value="{{ old('status_penyelidikan', $cadanganbb->status_penyelidikan) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="status_pembebasan" name="status_pembebasan"
                                value="{{ old('status_pembebasan', $cadanganbb->status_pembebasan) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="catatan" name="catatan"
                                value="{{ old('catatan', $cadanganbb->catatan) }}">
                            @error('catatan')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="kabupaten" name="kabupaten"
                                value="{{ old('kabupaten', $cadanganbb->kabupaten) }}" required>
                            @error('kabupaten')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="kecamatan" name="kecamatan"
                                value="{{ old('kecamatan', $cadanganbb->kecamatan) }}" required>
                            @error('kecamatan')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="date" class="form-control" id="masa_berlaku_iup" name="masa_berlaku_iup"
                                value="{{ old('masa_berlaku_iup', $cadanganbb->masa_berlaku_iup) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="date" class="form-control" id="masa_berlaku_ppkh" name="masa_berlaku_ppkh"
                                value="{{ old('masa_berlaku_ppkh', $cadanganbb->masa_berlaku_ppkh) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="umur_cadangan_thn" name="umur_cadangan_thn"
                                value="{{ old('umur_cadangan_thn', $cadanganbb->umur_cadangan_thn) }}"readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="umur_masa_berlaku_izin"
                                ...
                                value="{{ old('umur_masa_berlaku_izin', $cadanganbb->umur_masa_berlaku_izin) }}"readonly>
                            @error('umur_masa')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
